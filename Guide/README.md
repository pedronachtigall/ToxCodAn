...
#### Heatmaps
The package [**pheatmap**](https://github.com/raivokolde/pheatmap) is useful for making Heatmaps of expression across many individuals. To annotate the heatmaps, we need to load in the sample data.
...
You could also use a phylogeny as the tree for the heatmap using **ape** and **phytools**.
