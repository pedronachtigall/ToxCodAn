...
**[Q2]** How long will take to Venomancer finish the analysis?
  - We tested Venomancer using a personal computer (6-Core i7 with 16Gb memory) and 6 threads (```-c 6```), it took only 55 minutes to perform an analysis on a dataset with more than 146,077 sequences. If the user has more threads available for use, the running time will decrease.
